	...
	function doAction(no, viewCnt) {
		...
		<c:choose>
			<c:when test="${ not empty loginMember }">	
				location.href = '${ pageContext.request.contextPath }/board/boardDetail.do?no='+ no +'&type=boardList';	
			</c:when>
			<c:otherwise>
				   ...
				   <c:forEach items="${ boardList }" var="board" varStatus="loop">	
					...
					<tr>
						...
						<td id="title" class="row">
							...
							<div id="re">
									└<img src="${ pageContext.request.contextPath }/resources/images/reply-img.png" /> 
							</div>
							</c:if>
