...
$(document).ready(function(){
	...
	$('#deleteBtn').click(function(){
		boardNo = ${ board.no }
		location.href = "${ pageContext.request.contextPath }/board/boardDelete.do?no="+boardNo
	})
	
	$('#goReplyBtn').click(function(){
		
		boardNo = ${ board.no }
		location.href= "${ pageContext.request.contextPath }/board/boardReply.do?no="+boardNo
	})
})
