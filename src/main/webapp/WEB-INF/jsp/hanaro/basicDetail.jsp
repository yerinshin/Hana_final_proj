            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  <div class="service-box account-box">
                    ...
                    <h3 id="nickname">기본금</h3> 
                 
                     <h4 id="accountNo">${ hanaro.accountNo }</h4>
                     <h1 id="balance"> ${ hanaro.basicBalance }원</h1>
                    <div class="row">
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <table class="table">
					...
					<c:forEach items="${ historyList }" var="basicHistory" varStatus="loop">
					    <tr>
					   <td>${ basicHistory.transDate }</td>
					   <c:choose>
					    <c:when test="${ basicHistory.splitFrom eq 'basic_balance' }"> 
					      <td>${ basicHistory.splitTo }</td>
					        <td>${ basicHistory.memo }</td>
					      <th scope="row" id="send-trans-money">  -${ basicHistory.transMoney }원</th>
					     </c:when>
					     <c:otherwise>
					      <td>${ basicHistory.splitFrom}</td>
					        <td>${ basicHistory.memo }</td>
					      <th scope="row" id="receive-trans-money"> +${ basicHistory.transMoney } 원</th>
					    </c:otherwise>
					    </c:choose>
					      <td>${ basicHistory.basicBalance }원</td>
					    </tr>
					 </c:forEach>
