            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  <div class="service-box account-box">
                    ...
                    <h3 id="nickname">생활금</h3> 
                 
                     <h4 id="accountNo">${ hanaro.accountNo }</h4>
                     <h1 id="balance"> ${ hanaro.consumptionBalance }원</h1>
                    <div class="row">
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <table class="table">
					...
					<c:forEach items="${ historyList }" var="consumptionHistory" varStatus="loop">
					    <tr>
					   <td>${ consumptionHistory.transDate }</td>
					   <c:choose>
					    <c:when test="${ consumptionHistory.splitFrom eq 'consumption_balance' }"> 
					     ...
					     <c:otherwise>
					      ...
					      <td>${ consumptionHistory.consumptionBalance }원</td>
					    </tr>
					 </c:forEach>
