...
<script>
	function goAccountDetail(accountNo) {
		location.href='${ pageContext.request.contextPath }/account/openAccountDetail.do?accountNo='+accountNo
...
<body class="main-layout">
      ...
      <div class="service">
         ...
         <div class="container">
           ...
           <div class="row">
           <img class= "logo-img" src="${ pageContext.request.contextPath }/resources/images/jh-logo.png">
           <h2>[ JH Bank ]</h2>
           </div>
            <div class="row">
            ...
            <br>
             <div class="row">
           <img class= "logo-img" src="${ pageContext.request.contextPath }/resources/images/sw-logo.png">
            <h2> [ SW Bank ] </h2>
            </div>
            <div class="row">
            ...
            <hr>
            <div class="row">
           <img class= "logo-img" src="${ pageContext.request.contextPath }/resources/images/sj-logo.png">
           <h2>[ SJ Bank ] </h2>
           </div>
            <div class="row">
			 ...
			 <h2>JH뱅크</h2>
				<c:forEach items="${ JHAccountList }" var="account" varStatus="loop">	
	               <div class="col-md-6">
	                  ...
	                  <a id="nickname" href="${ pageContext.request.contextPath }/account/accountDetail.do?accountNo=${account.accountNo}"> 
	                     ${ account.accountNickName }
	                  </a>
	                     <h4 id="accountNo">${ account.accountNo }</h4>
	                     <h1 id="balance"> ${ account.balance }원</h1>
