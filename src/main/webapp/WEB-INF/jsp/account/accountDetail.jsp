...
<%-- 
		...
		$('#updateBtn').click(function(){
			boardNo = ${ board.no }
			location.href = "${ pageContext.request.contextPath }/board/boardUpdate.do?no="+boardNo
	 ...
	 --%>
	 	...
	 	$('#acc-trans-btn').click(function(){
	 		console.log('눌림')
	 		location.href = "${ pageContext.request.contextPath }/account/accountTransfer.do?accountNo=${ account.accountNo }"
	 	})
	 
		$('#acc-delete-btn').click(function(){
			accountNo = ${ account.accountNo }
			location.href = "${ pageContext.request.contextPath }/account/accountDeleteCheck.do?accountNo=${ account.accountNo }"
		})
	})
</script>
</head>
